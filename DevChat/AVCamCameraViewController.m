	...
	dispatch_async( self.sessionQueue, ^{
		...
		dispatch_async( dispatch_get_main_queue(), ^{
            [self.delegate shouldEnableCameraUI:YES];
             ...
             [self.delegate shouldEnableRecordUI:self._captureModeControl.selectedSegmentIndex == AVCamCaptureModeMovie];
...
- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary *)change context:(void *)context
{
	if ( context == SessionRunningContext ) {
		...
		dispatch_async( dispatch_get_main_queue(), ^{
            ...
            [self.delegate shouldEnableRecordUI:isSessionRunning && ( self._captureModeControl.selectedSegmentIndex == AVCamCaptureModeMovie)];
